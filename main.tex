...
% GBB: yes, the residuals are larger for the point source because PSF effects are more important (the modelling codes typicall assume a constant PSF, say, F140W).
